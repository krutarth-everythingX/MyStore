...
export const SellerProducts = () => {
  ...
  const handleOpenEdit = async (prod) => {
    try {
      ...
      // Setup warehouse edit if present
      ...
      alert(err.message || 'Failed to open edit form');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="seller-dashboard-container container">
          ...
          {user && !user.email_verified_at && (
            <div className="form-alert form-alert-error body-md" style={{ display: 'flex', alignItems: 'center', marginBottom: 20 }}>
              ...
              <span>
                <strong>Email Verification Required:</strong> Please verify your email address to add, edit or manage products. <Link to="/seller/profile" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>Verify email now</Link>.
              </span>
            </div>
          )}
