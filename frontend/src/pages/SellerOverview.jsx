...
export const SellerOverview = () => {
  ...
  const handleExport = async (type) => {
    try {
      ...
      const res = await fetch(`${API_BASE}/seller/export/${endpoint}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'text/csv'
        }
              ...
              <div className="seller-dashboard-main-grid grid-12">
                <div className="col-span-8" style={{ gridColumn: 'span 8' }}>
                  <Card
                    ...
                    extra={
                      <Link to="/seller/orders" className="recent-sales-link label-md">
                ...
                <div className="col-span-4" style={{ gridColumn: 'span 4', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-lg)' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        {stats.low_stock_products.map((p) => (
                          <div key={p.id} className="low-stock-alert-item animate-fade-in">
                            ...
                            <Link to="/seller/products" className="low-stock-action-link">
                              Restock
                            </Link>
                          </div>
                        ))}
                  ...
                  <Card title="Quick Management Links" className="quick-links-card">
                    <div className="quick-links-list">
                      <Link to="/seller/products" className="quick-link body-md">
                        <span>🏷️ Add New Product</span>
                        <ArrowRight size={16} />
                      </Link>
                      <Link to="/seller/inventory" className="quick-link body-md">
                        <span>🏭 Manage Warehouses</span>
                        <ArrowRight size={16} />
                      </Link>
                      <Link to="/seller/orders" className="quick-link body-md">
                        <span>📦 Process Pending Shipments</span>
                        <ArrowRight size={16} />
                      </Link>
                      <Link to="/seller/profile" className="quick-link body-md">
