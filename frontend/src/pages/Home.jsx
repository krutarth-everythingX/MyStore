...
export const Home = () => {
  ...
  useEffect(() => {
    // Fetch categories and brands for filtering sidebar
          ...
          <div className="homepage-sections animate-fade-in">
            ...
            <section className="home-section featured-window-section">
              ...
              {filteredProducts.length > 0 ? (
                <div className="featured-tiles-grid">
                  ...
                  <Link to="/?explore=true" className="product-card-container shadow-sm explore-tile-card">
            ...
            <section className="home-section explore-by-cat-section">
              ...
              <div className="ecb-view-all-row">
                <Link to="/categories" className="ecb-view-all-btn">
                  View All Categories →
                </Link>
              </div>
            </section>
